...
import (
	...
	"github.com/angusburroughs/learnBlockChain/blockchain/wallet"
)
...
func (cli *CommandLine) printUsage() {
	...
	fmt.Println("printchain -address ADDRESS - Prints the blocks in the chain")
